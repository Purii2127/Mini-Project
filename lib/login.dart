...
import 'package:flutter_application_1/Loginmain.dart';
        ...
        child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: const Text(
                  'Welcome To',
                  style: TextStyle(fontSize: 40, fontWeight: FontWeight.bold, fontFamily: 'Aelo'),
                ),
              ),
              Container(
                height: 60,
                ...
                child: const Column(
                  ...
                  children: [
                    Text('แอปพิลเคชั่น ซื้อ-ขาย ลอตเตอรี่ หวย ออนไลน์',
                        style:
                            TextStyle(color: Color.fromARGB(255, 68, 68, 68), fontWeight: FontWeight.w300, fontFamily: 'Aelo')),
